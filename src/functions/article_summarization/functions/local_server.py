"""Local development server for the article summarization Cloud Function."""
...
def local_handler():
    """Proxy HTTP requests to the summarization handler."""
...
if __name__ == "__main__":
    ...
    print(f"Starting article summarization server on http://localhost:{port}")
    print(
