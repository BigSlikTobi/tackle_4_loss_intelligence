#!/bin/bash
# Deployment script for the team article generation Cloud Function

set -euo pipefail

FUNCTION_NAME="team-article-generation"
REGION="us-central1"
RUNTIME="python312"
ENTRY_POINT="team_article_generation_handler"
MEMORY="2048MB"
TIMEOUT="540s"
...
TEMP_DEPLOY_DIR=$(mktemp -d -t team-article-generation-deploy.XXXXXX)
