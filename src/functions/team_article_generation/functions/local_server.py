"""Local development server for the team article generation Cloud Function."""
...
def local_handler():
    """Proxy HTTP requests to the team article generation handler."""
...
if __name__ == "__main__":
    ...
    print(f"Starting team article generation server on http://localhost:{port}")
    print(
