"""Local testing entry point for data_loading Cloud Function.

This file uses absolute imports for local testing with functions-framework.
The actual deployment uses main.py with relative imports.
"""
