"""Local development server for the article translation Cloud Function."""
...
def local_handler():
    """Proxy HTTP requests to the article translation handler."""
...
if __name__ == "__main__":
    ...
    print(f"Starting article translation server on http://localhost:{port}")
    print(
